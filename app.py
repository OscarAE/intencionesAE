...
def admin_seed():
    ...
    intenciones = [
        ...
        # Salud
        (misa_id, cat_map["SALUD"], "FLORINDA SUAREZ", "", None),
        (misa_id, cat_map["SALUD"], "LAURA LARA", "", None),
        (misa_id, cat_map["SALUD"], "GLORIA CORREDOR", "", None),
        (misa_id, cat_map["SALUD"], "ROSA DEBIA", "", None),
        (misa_id, cat_map["SALUD"], "MARTIN GOMEZ", "", None),
        (misa_id, cat_map["SALUD"], "VERONICA AVILA", "", None),
        (misa_id, cat_map["SALUD"], "GABRIELA AVILA", "", None),
        (misa_id, cat_map["SALUD"], "MATALIA MARTINEZ", "", None),
        (misa_id, cat_map["SALUD"], "RICARDO MENDEZ", "", None),
        (misa_id, cat_map["SALUD"], "ALFONSO GALEANO", "", None),
        (misa_id, cat_map["SALUD"], "SONIA TELLEZ", "", None),
        (misa_id, cat_map["SALUD"], "EDUARDO SUAREZ", "", None),
        (misa_id, cat_map["SALUD"], "CLARA RODRIGUEZ", "", None),
        (misa_id, cat_map["SALUD"], "DISNEY SUAREZ", "", None),
        (misa_id, cat_map["SALUD"], "LEIDY ALDANA", "", None),
        (misa_id, cat_map["SALUD"], "MARIA INEZ ROJAS", "", None),
        (misa_id, cat_map["SALUD"], "MAURICIO PEDREROS", "", None),
        (misa_id, cat_map["SALUD"], "LEIDY PEDREROS", "", None),
        (misa_id, cat_map["SALUD"], "YAMILE CAMACHO", "", None),
        (misa_id, cat_map["SALUD"], "ENFERMOS DE CANCER", "", None),
        (misa_id, cat_map["SALUD"], "BLANCA ORJUELA", "", None),
        (misa_id, cat_map["SALUD"], "FAMILIA NIÑO GARZON", "", None),
        (misa_id, cat_map["SALUD"], "FAMILIA CABREARA CARDENAS", "", None),
        (misa_id, cat_map["SALUD"], "FAMILIA CORZO VERGARA", "", None),
        (misa_id, cat_map["SALUD"], "FAMILIA CAMACHO AMAYA", "", None),
        (misa_id, cat_map["SALUD"], "FAMILIA PAEZ", "", None),
        (misa_id, cat_map["SALUD"], "FAMILIA ROSA ZEA", "", None),
        (misa_id, cat_map["SALUD"], "FAMILIA TELLEZ PULIDO", "", None),
        (misa_id, cat_map["SALUD"], "FAMILIA CORTES CASTRO", "", None),
        (misa_id, cat_map["SALUD"], "FAMILIA EDUARDO RUIZ", "", None),
        (misa_id, cat_map["SALUD"], "FAMILIA MATEO SANCHEZ", "", None),
        (misa_id, cat_map["SALUD"], "POR LA SALUD Y BIENESTAR DE LAS FAMILIAS BERNAL BERNAL", "", None),
        (misa_id, cat_map["SALUD"], "POR LA SALUD Y BIENESTAR DE LAS FAMILIAS ORTEGA MORENO", "", None),
        (misa_id, cat_map["SALUD"], "POR LA SALUD Y BIENESTAR DE LA FAMILIA TELLEZ MORENO", "", None),
        (misa_id, cat_map["SALUD"], "POR LA SALUD Y BIENESTAR DE LA FAMILIA ZABALA TELLEZ", "", None),
        (misa_id, cat_map["SALUD"], "POR LA SALUD Y BIENESTAR DE LA FAMILIA HERMANA GORDILLO", "", None),
        (misa_id, cat_map["SALUD"], "POR LA SALUD Y BIENESTAR DE LA FAMILIA CAROLINA RIZO Y SU BEBE", "", None),
        (misa_id, cat_map["SALUD"], "POR LA SALUD Y BIENESTAR DE LA FAMILIA VIRGINIA PARDO Y FAMILIA", "", None),
        (misa_id, cat_map["SALUD"], "POR LA SALUD Y BIENESTAR DE LA FAMILIA EDUARDO RUIZ", "", None),
        (misa_id, cat_map["SALUD"], "POR LA SALUD Y BIENESTAR DE LA FAMILIA MATEO SANCHEZ", "", None),
        (misa_id, cat_map["SALUD"], "POR LA SALUD Y PROSPERIDAD DE LA FAMILIA GONZALEZ BONILLA", "", None),
        (misa_id, cat_map["SALUD"], "POR LA SALUD FISICA Y ESPIRITUAL DE YULIETH QUITIAN", "", None),
        (misa_id, cat_map["SALUD"], "POR LA SALUD FISICA Y ESPIRITUAL DE GERINSON MARTINEZ", "", None),
        
        # Difuntos
        (misa_id, cat_map["DIFUNTOS"], "JOSE IBORRA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "CALRA VALERO", "", None),
        (misa_id, cat_map["DIFUNTOS"], "EDUARDO CARDENAS", "", None),
        (misa_id, cat_map["DIFUNTOS"], "ELIAS CORZO", "", None),
        (misa_id, cat_map["DIFUNTOS"], "CELIA VERGARA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "LEONEL VERGARA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "MARIA GOMEZ", "", None),
        (misa_id, cat_map["DIFUNTOS"], "ANTONIO AHUMADA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "ALVARO VARGAS", "", None),
        (misa_id, cat_map["DIFUNTOS"], "ROSA MALAVER", "", None),
        (misa_id, cat_map["DIFUNTOS"], "BENILDE ORJUELA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "RAUL ORJUELA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "LEONOR BECERRA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "CARLOS BECERRA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "ASUNCION BECERRA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "ANA ROSA MENDOZA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "CLARA INEZ FELACIO", "", None),
        (misa_id, cat_map["DIFUNTOS"], "LUIS SOLARTE Y NELLY DE SOLARTE", "", None),
        (misa_id, cat_map["DIFUNTOS"], "BENDITAS ALMAS DEL PURGATORIO", "", None),
        (misa_id, cat_map["DIFUNTOS"], "ALVARO SARMIENTO", "", None),
        (misa_id, cat_map["DIFUNTOS"], "SARA DE SARMIENTO", "", None),
        (misa_id, cat_map["DIFUNTOS"], "IGNACIO BUITRAGO", "", None),
        (misa_id, cat_map["DIFUNTOS"], "PATRICIA MALAVER", "", None),
        (misa_id, cat_map["DIFUNTOS"], "LISETH ACOSTA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "JORGE VILLARRAGA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "DIFUNTOS DE LA FAMILIA PAEZ", "", None),
        (misa_id, cat_map["DIFUNTOS"], "DIFUNTOS DE LA FAMILIA DURAN", "", None),
        (misa_id, cat_map["DIFUNTOS"], "DIFUNTOS DE LA FAMILIA RODRIGUEZ", "", None),
        (misa_id, cat_map["DIFUNTOS"], "DIFUNTOS DE LA FAMILIA LEON", "", None),
        (misa_id, cat_map["DIFUNTOS"], "DIFUNTOS DE LA FAMILIA PAGUAY", "", None),
        (misa_id, cat_map["DIFUNTOS"], "DIFUNTOS DE LA FAMILIA LEURO PEDRAZA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "DIFUNTOS DE LA FAMILIA DIAZ LEURO", "", None),
        (misa_id, cat_map["DIFUNTOS"], "DIFUNTOS DE LA FAMILIA GOMEZ", "", None),
        (misa_id, cat_map["DIFUNTOS"], "DIFUNTOS DE LA FAMILIA ESPINOSA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "CLENTE COBA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "INGRID ARENAS", "", None),
        (misa_id, cat_map["DIFUNTOS"], "OLMEDO ORJUELA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "ELISEO ORJUELA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "ALBA BRAVO", "", None),
        (misa_id, cat_map["DIFUNTOS"], "VICENTE VELEZ", "", None),
        (misa_id, cat_map["DIFUNTOS"], "JUAN JOSE MORA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "ROSA CASTELLANOS", "", None),
        (misa_id, cat_map["DIFUNTOS"], "JOSE CAGUA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "DANIEL LOMBANA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "PEDRO NIETO", "", None),
        (misa_id, cat_map["DIFUNTOS"], "JOSE CELY", "", None),
        (misa_id, cat_map["DIFUNTOS"], "FLOR LOPEZ", "", None),
        (misa_id, cat_map["DIFUNTOS"], "GABRIEL LAFONT", "", None),
        (misa_id, cat_map["DIFUNTOS"], "JAIME VILLAMIZAR", "", None),
        (misa_id, cat_map["DIFUNTOS"], "JOSE MOLANO", "", None),
        (misa_id, cat_map["DIFUNTOS"], "FRANCISCA QUIROZ", "", None),
        (misa_id, cat_map["DIFUNTOS"], "FLAVIO CARDONA", "", None),
        (misa_id, cat_map["DIFUNTOS"], "EVA BOHORQUEZ", "", None),
        (misa_id, cat_map["DIFUNTOS"], "RAFAEL SEPULVEDA", "", None),
